  ...
  return (
    <div className="login-wrap">
      <div className="login-card">
        ...
        <p>Fågelspotting — fota en fågel, låt AI:n känna igen arten, samla poäng.</p>
        ...
        {state.message && (
          <div className={`callout ${state.message.includes("Kolla din e-post") ? "" : "error"}`} aria-live="polite">
            {state.message}
          </div>
        )}
