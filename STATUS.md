...
- 🔄 **Daniel: "650 dagar synkade för mig, max 1 år räcker för andra användare, sluta synka mina pass."** Verifierat direkt mot databasen att Daniels konto hade 784 pass över 639 dagar tillbaka till 2019 — aktivitetsbackfillen hade ingen ålderscap (bara wellness-historiken hade det). Fixat: backfillen stoppar nu vid 1 år för alla andra användare, och admin-kontot hoppar helt över både Garmin- och Concept2-sync. Kod klar, typkontrollerad, byggd rent, pushad. **Inte verifierat live än** — Daniel valde att köra utan att ge en ny Vercel-token den här gången, så deployen har inte bekräftats READY mot produktion. Vercels git-koppling brukar deploya automatiskt vid push för den här appen; kollar och bekräftar nästa gång jag har token eller när Daniel säger att han sett förändringen på riktigt.
