...
export default async function ViktmalPage() {
  ...
  // Ett enda Promise.all istället för två efter varandra — den andra
  // omgången frågor berodde aldrig på resultatet av den första (bara på
  // profile/user/todayKey/trendDays som redan fanns), så uppdelningen
  // kostade en hel extra nätverkstur tur-och-retur till databasen vid
  // varje sidladdning helt i onödan (Daniel: "segt att klicka vidare").
  const [
