    ...
    <div className="p-4 md:p-8 max-w-2xl lg:max-w-5xl w-full mx-auto space-y-6">
      ...
      <div className="bg-card border border-edge rounded-2xl p-4 flex flex-col gap-4">
        ...
        <button
          ...
          className="bg-accent text-bg text-sm font-semibold px-4 py-2.5 rounded-xl disabled:opacity-50 disabled:bg-edge disabled:text-muted disabled:cursor-not-allowed hover:opacity-90 transition-opacity"
        >
