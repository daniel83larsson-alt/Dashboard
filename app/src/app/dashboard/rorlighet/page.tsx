...
export default function RorlighetPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-2xl w-full mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold">Rörlighet</h1>
        <p className="text-muted text-sm mt-1">Välj vad du vill stretcha, så sätter vi ihop ett pass åt dig — förankrat i forskning, inte AI-gissat</p>
      </div>
